...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, SensorEventListener {
    ...
    private ToggleButton toggleNight;   // ← Added
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleNight = findViewById(R.id.toggleNight);   // ← Added
    ...
    private void setupButtons() {
        ...
        // Added: Night mode toggle for testing
        toggleNight.setOnCheckedChangeListener((buttonView, isChecked) -> {
            isNight = isChecked;
            if (isChecked) {
                Toast.makeText(this, "Night mode forced ON for testing", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Night mode following real time", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void startScreamDetection() {
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            @Override
            public void run() {
                checkTime();           // still updates real time
    ...
    private void checkTime() {
        // Only update isNight from time if toggle is NOT checked
    ...
    private void enableLocation() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.SEND_SMS}, 101);
        }
    }
